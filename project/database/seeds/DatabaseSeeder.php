...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Exam::create(['examination_period' => 'Jun', 'grade' => 9, 'passed' => 'yes', 'student_id' => User::where('email', 'kosta@gmail.com')->get()->first()->id, 'course_id' => 'BRTSI7200', 'created_at' => '2015-05-27 15:00:00']);
